...
public class Tag{
    ...
    private ArrayList<in.snapnsave.models.SmartContent> associatedContent;
    public Tag(long tagId, String tagName, boolean isUniqueContent) {
        this.tagId = tagId;
        this.tagName = tagName;
        this.isUniqueContent = isUniqueContent;
        associatedContent = new ArrayList<in.snapnsave.models.SmartContent>();
    ...
    public ArrayList<in.snapnsave.models.SmartContent> getAssociatedContent() {
        return associatedContent;
    }

    public void addAssociatedContent(in.snapnsave.models.SmartContent sC) {
