...
//    static final String colText = "colText";
    ...
    public HashMap<String, in.snapnsave.models.ContentTypeEnum> fileExtensionHash;
    // data structure to load and hold the files data
    private ArrayList<in.snapnsave.models.SmartContent> smartContentData;
    private HashMap<Long, in.snapnsave.models.SmartContent> smartContentHash;
    // data structure to load and hold the tags data
    private ArrayList<Tag> tagData;
    // data Structure to store text Content in memory
    private HashMap<Long, in.snapnsave.models.TextContent> textContentHash;
    ...
    public HashMap<Long, in.snapnsave.models.SmartContent> getSmartContentHash() {
        return smartContentHash;
    }

    public HashMap<Long, in.snapnsave.models.TextContent> getTextContentHash() {
        return textContentHash;
    }

    public ArrayList<in.snapnsave.models.SmartContent> getSmartContentData() {
 ...
 //       dbResponse = null;
    ...
    private void populateFileTypesTable(SQLiteDatabase db) {
        ...
        for (String extension : image) {
            ...
            cv.put(DatabaseHandler.colContentCategory, in.snapnsave.models.ContentTypeEnum.Image.ordinal());
            db.insert(contentTypesTable, null, cv);
            cv.clear();
        }
        for (String extension : video) {
            cv.put(DatabaseHandler.colContentExtension, extension);
            cv.put(DatabaseHandler.colContentCategory, in.snapnsave.models.ContentTypeEnum.Video.ordinal());
            db.insert(contentTypesTable, null, cv);
            cv.clear();
        }
        for (String extension : audio) {
            cv.put(DatabaseHandler.colContentExtension, extension);
            cv.put(DatabaseHandler.colContentCategory, in.snapnsave.models.ContentTypeEnum.Audio.ordinal());
            db.insert(contentTypesTable, null, cv);
            cv.clear();
        }
        for (String extension : document) {
            cv.put(DatabaseHandler.colContentExtension, extension);
            cv.put(DatabaseHandler.colContentCategory, in.snapnsave.models.ContentTypeEnum.Document.ordinal());
            db.insert(contentTypesTable, null, cv);
            cv.clear();
        }
     ...
     * @return
     */
    public long addFile(String filename, String fileAddress, String contentDescription, in.snapnsave.models.ContentTypeEnum contentType) {
...
//    }
    ...
    public void loadData() throws FileNotFoundException {
        ...
        fileExtensionHash = new HashMap<String, in.snapnsave.models.ContentTypeEnum>();
        smartContentData = new ArrayList<in.snapnsave.models.SmartContent>();
        smartContentHash = new HashMap<Long, in.snapnsave.models.SmartContent>();
        tagData = new ArrayList<Tag>();
        textContentHash = new HashMap<Long, in.snapnsave.models.TextContent>();
        ...
        while (cur.moveToNext()) {
            in.snapnsave.models.SmartContent sC = new in.snapnsave.models.SmartContent(cur.getLong(0), cur.getString(1), cur.getString(2), cur.getString(3), cur.getInt(4));
            ...
            if (sC.getContentUnit().getContentType() == in.snapnsave.models.ContentTypeEnum.Note
                    || sC.getContentUnit().getContentType() == in.snapnsave.models.ContentTypeEnum.Location) {
                ...
                textContentHash.put(sC.getContentID(), new in.snapnsave.models.TextContent(sC.getContentID(), contentText));
            }
        ...
        while (cur.moveToNext()) {
            ...
            fileExtensionHash.put(extension, in.snapnsave.models.ContentTypeEnum.enumFromInt(fileCategory));
        }
        if (cur != null)
            cur.close();
    ...
    public void addSmartContentInMemory(in.snapnsave.models.SmartContent sC) {
    ...
    public String populateDemoTV() {
        ...
        for (int i = 0; i < tagData.size(); i++) {
            ...
            ArrayList<in.snapnsave.models.SmartContent> associatedContent = tagData.get(i).getAssociatedContent();
    ...
    public void saveExtensionType(String extension, in.snapnsave.models.ContentTypeEnum contentType) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(DatabaseHandler.colContentExtension, extension);
    ...
    public void deleteSmartContent(long contentID) {
        in.snapnsave.models.SmartContent sC = smartContentHash.get(contentID);
...
//        }
        ...
        for(int i =0; i<newTags.size(); i++){
            ...
            if(tagID == -1 )     // not present - create tag in tag table and add entry in contentTag table
            {
                ...
                if(tag.isUniqueContent() && newTagsUniqueness.get(i)==false){
                    ...
                    ArrayList<in.snapnsave.models.SmartContent> associatedFiles = tag.getAssociatedContent();
     ...
     * @return
     */
    public ArrayList<in.snapnsave.models.SmartContent> getRecentContentData() {
        ArrayList<in.snapnsave.models.SmartContent> result = new ArrayList<in.snapnsave.models.SmartContent>();
    ...
    public ArrayList<String> getAutoCompleteTerms() {
        ...
        Collection<in.snapnsave.models.TextContent> collection = textContentHash.values();
        Iterator itr = collection.iterator();
        while (itr.hasNext()) {
            in.snapnsave.models.TextContent tc = (in.snapnsave.models.TextContent) itr.next();
        ...
        for (in.snapnsave.models.SmartContent sc : smartContentData) {
    ...
    public ArrayList<in.snapnsave.models.SmartContent> getAssociatedContent(long tagId){
        Tag tag = tagHash.get(tagId);
        ArrayList<in.snapnsave.models.SmartContent> associatedContent = (ArrayList<in.snapnsave.models.SmartContent>)tag.getAssociatedContent().clone();
    ...
    public ArrayList<Tag> getRelatedTags(Long tagId) {
        ...
        ArrayList<in.snapnsave.models.SmartContent> associatedContent = tag.getAssociatedContent();
        ArrayList<Tag> returnList = new ArrayList<>();
        for(in.snapnsave.models.SmartContent sc : associatedContent){
